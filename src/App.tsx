...
function App() {
  return (
    <div className="flex justify-center border-solid border-2 border-black overflow-hidden py-12 bg-gradient-to-tl from-white via-gray-200 to-blue-300 h-screen">
      <div className="max-w-sm rounded-xl shadow-lg bg-gray-100 border-solid border-2 border-black">
